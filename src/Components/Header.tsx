...
export const Header = () => {
    const Active = "text base block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500";
    ...
    const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
        ...
        const queryT = (e.currentTarget.elements.namedItem('search') as HTMLInputElement).value; // Get the search value
        e.currentTarget.reset(); // Reset the form
        navigate(`/Search?q=${queryT}`); // Navigate to the search page
    }
                ...
                <div>
                    <nav className="bg-white border-gray-200 dark:bg-gray-900">
                        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                            <a href="/" className="flex items-center space-x-7 rtl:space-x-reverse">
                                <img src={logo} className="h-10" alt="CineVert-logo" />
                            </a>
                            ...
                            <div className={`items-center justify-between ${hidden} w-full md:flex md:w-auto md:order-1`} id="navbar-search">
                                ...
                                <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                                    ...
                                    <li>
                                        <NavLink to="/Movie/Contact" className={({ isActive }) => isActive ? Active : inActive}>Contact</NavLink>
                                    </li>
                                </ul>
                            </div>
                        </div>
